    ...
    return GetBuilder<StaffController>(builder: (controller) {
      return Expanded(
        child: GestureDetector(
          ...
          child: DecoratedBox(
            decoration: BoxDecoration(
              color: controller.selectedTab == title ? AppColor.primaryColor : Colors.transparent,
            ...
            child: Padding(
              ...
              child: S14Text(
                ...
                color: controller.selectedTab == title ? AppColor.white : AppColor.primaryColor,
                fontWeight: controller.selectedTab == title ? FontWeight.w600 : FontWeight.w500,
              ),
            ),
          ),
        ),
