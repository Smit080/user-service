          ...
          Expanded(
            child: ListView(
              ...
              children: [
                      ...
                      return ListView(
                        ...
                        children: [
                          pageViewBtn(
                              ...
                              isSelected: controller.selectedTime == AppStrings.today,
                              onTap: () {
                          ...
                          pageViewBtn(
                              ...
                              isSelected: controller.selectedTime == AppStrings.weekly,
                              onTap: () {
                          ...
                          pageViewBtn(
                              ...
                              isSelected: controller.selectedTime == AppStrings.monthly,
                              onTap: () {
                          ...
                          pageViewBtn(
                              ...
                              isSelected: controller.selectedTime == AppStrings.yearly,
                              onTap: () {
                          ...
                          pageViewBtn(
                              ...
                              isSelected: controller.selectedTime == AppStrings.upcoming,
                              onTap: () {
                          ...
                          children: [
                            Expanded(
                              child: pageViewBtn(
                                ...
                                isSelected: controller.selectedType == AppStrings.byEmployee,
                                onTap: () {
                            ...
                            Expanded(
                              child: pageViewBtn(
                                ...
                                isSelected: controller.selectedType == AppStrings.byService,
                                onTap: () {
                                  controller.selectedType = AppStrings.byService;
                                  controller.update();
                                },
                              ),
                            ),
                ...
                GetBuilder<SellsController>(
                  builder: (controller) {
                    bool isEmployee = controller.selectedType == AppStrings.byEmployee;
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      S16Text(
                                        isEmployee ? "Employee name" : "Service name",
                                        fontWeight: FontWeight.w700,
                                      ),
                                      3.vertical(),
                                      if (isEmployee)
                                        const DualText(text1: "Assigned service", text2: "5"),
                                      if (isEmployee) 1.5.vertical(),
                                      const DualText(text1: "Total appointment", text2: "10"),
                                    ],
                                  ),
                                ),
                                const Column(
  ...
  Widget pageViewBtn({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: EdgeInsets.symmetric(horizontal: 20, vertical: isType ? 10 : 0),
        child: S14Text(
          title,
          textAlign: TextAlign.center,
